...
namespace
{
    const char* const WINDOW_TITLE = "5-3 Assignment: Texturing a Pyramid"; // Macro for window title
...
int main(int argc, char* argv[])
{
    ...
    // Load texture
    const char* texFilename = "white_bricks.jpg";
...
void UCreateMesh(GLMesh& mesh)
{
    ...
    mesh.nVertices = sizeof(verts) / (floatsPerVertex + floatsPerUV + floatsPerColor);
