...
namespace
{
	const char* const WINDOW_TITLE = "3-5 Milestone: Beginning a 3D Scene"; // Macro for window title
...
void URender()
{
	...
	// 1. Scales the object
	scale = glm::scale(glm::vec3(17.0f, 3.0f, 22.0f));
	// 2. Rotate the object
	rotation = glm::rotate(0.0f, glm::vec3(1.0, 1.0f, 1.0f));
	// 3. Position the object
	translation = glm::translate(glm::vec3(0.0f, 0.0f, 0.0f));
	...
	// Wooden Board Color 
	glProgramUniform4f(gProgramId, objectColorLoc, 0.54f, 0.38f, 0.22f, 0.0f);
	...
	// 1. Scales the object
	scale = glm::scale(glm::vec3(50.0f, 1.0f, 21.0f));
	// 2. Rotate the object
	rotation = glm::rotate(0.0f, glm::vec3(1.0, 1.0f, 1.0f));
	// 3. Position the object
	translation = glm::translate(glm::vec3(0.0f, 0.0f, 0.0f));
	...
	// Dark Pink Carpet Color
	glProgramUniform4f(gProgramId, objectColorLoc, 1.0f, 0.5f, 0.5f, 0.0f);
	...
	// 1. Scales the object
	scale = glm::scale(glm::vec3(0.1f, 0.2f, 0.2f));
	// 2. Rotate the object
	rotation = glm::rotate(5.0f, glm::vec3(1.0, 1.0f, 1.0f));
	// 3. Position the object
	translation = glm::translate(glm::vec3(0.0f, 1.5f, 5.0f));
	// Model matrix: transformations are applied right-to-left order
	model = translation * rotation * scale;
	glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));

	// Silver Color for the Clasp 
	glProgramUniform4f(gProgramId, objectColorLoc, 0.71f, 0.71f, 0.71f, 0.0f);
	...
	// dark blue sphere
	glProgramUniform4f(gProgramId, objectColorLoc, 0.0f, 0.20f, 0.44f, 0.0f);
