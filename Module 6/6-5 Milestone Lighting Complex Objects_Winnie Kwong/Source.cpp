...
namespace
{
	const char* const WINDOW_TITLE = "6-5 Milestone: Lighting Complex Objects"; // Macro for window title
...
int main(int argc, char* argv[])
{
	...
	// Load plane
	const char* texFilename = "../6-5 Milestone Lighting Complex Objects_Winnie Kwong/Texture/foam_board.jpg";
	if (!UCreateTexture(texFilename, texture0))
	{
		cout << "Failed to load texture " << texFilename << endl;
	}
	// Load clasp & hook
	texFilename = "../6-5 Milestone Lighting Complex Objects_Winnie Kwong/Texture/metal.jpg";
	if (!UCreateTexture(texFilename, texture1))
	{
		cout << "Failed to load texture " << texFilename << endl;
	}
	// Load body
	texFilename = "../6-5 Milestone Lighting Complex Objects_Winnie Kwong/Texture/ornament_body.jpg";
...
void URender()
{
	...
	// 1. Scales the object
	scale = glm::scale(glm::vec3(8.0f, 1.0f, 8.0f));
	// 2. Rotate the object
	rotation = glm::rotate(0.0f, glm::vec3(1.0, 1.0f, 1.0f));
	// 3. Position the object
	translation = glm::translate(glm::vec3(1.33f, 0.0f, 2.0));
	...
	// 3. Position the object
	translation = glm::translate(glm::vec3(1.35f, 0.15f, 2.0f));
	// Model matrix: transformations are applied right-to-left order
	model = translation * rotation * scale;
	glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
	// Draws texture
	...
	rotation = glm::rotate(0.0f, glm::vec3(1.0, 1.0f, 1.0f));
	// 3. Position the object
	translation = glm::translate(glm::vec3(1.33f, 0.13f, 2.0f));
	// Model matrix: transformations are applied right-to-left order
	model = translation * rotation * scale;
	glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
	// Draws the triangles
	...
	rotation = glm::rotate(0.0f, glm::vec3(1.0, 1.0f, 1.0f));
	// 3. Position the object
	translation = glm::translate(glm::vec3(2.0f, 1.0f, 2.0f));
	// Model matrix: transformations are applied right-to-left order
	model = translation * rotation * scale;
	glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
	// bind texture on corresponding texture unit
